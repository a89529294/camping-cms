...
export const localStorageUserIdentifierKey = "love-camping-user-identifier";
export const localStorageUserPasswordKey = "love-camping-user-password";
export const sliderSize = 200;
